  ...
  useEffect(() => {
    async function connectToMetamask() {
      if (typeof window.ethereum !== "undefined") {
        ...
        const result = await maticContract.getActivatedTokenByOwner(signerAddress)
        const count = await maticContract.getPassMembersCount(result.toNumber())
        for(let i=0; i<count; i++){
          const address = await maticContract.getPassMemberAt(result.toNumber(),i);
  ...
  return (
    <>
      ...
      :(
        ...
        data ===0 ? ( <Button size="lg" as={Link} to="/profile" variant="dark">Activate Your Pass</Button>): 
        <>
        {/* <div>{data}</div> */}
            ...
            <Card className="info-card">
              ...
              <Card.Body> 
                <blockquote className="blockquote mb-0">
                  ...
                  <Button onClick={handleShowADD} variant="dark">Add Members</Button> <></>
                  <Button onClick={handleShowREMOVE} variant="dark">Remove Members</Button>
                </blockquote>
              </Card.Body>
            </Card>
          </Row>
      ...
      centered 
      show={showAddMember} onHide={handleCloseADD}>
      ...
      aria-labelledby="contained-modal-title-vcenter"
      centered 
      show={showRemoverMember} onHide={handleCloseREMOVE}>
        <Modal.Header closeButton>
